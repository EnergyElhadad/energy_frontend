  ...
  return (
    <section className="relative w-full overflow-hidden">
      <div className="relative">
        ...
        {/* Pagination */}
        <div className="hero-pagination bg-red! absolute bottom-6! z-50! flex w-fit! -translate-x-1/2! gap-2 space-x-0 ltr:right-1/2! ltr:left-1/2! rtl:right-1/2! rtl:left-1/2!" />
      </div>
    </section>
  );
};
