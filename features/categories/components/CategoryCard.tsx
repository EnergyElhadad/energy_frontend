...
export const CategoryCard = ({ name, image, id }: CategoryCardProps) => {
  return (
    <Link href={`/products?categoryId=${id}&categoryName=${name}`}>
      <div className="border-Stroke hover:border-primary mx-auto h-full max-w-43.5 cursor-pointer rounded-2xl border bg-white px-4 py-5 text-center transition hover:shadow-md md:px-5 md:py-6">
